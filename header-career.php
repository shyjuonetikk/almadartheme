...
<div id="career-overlays" class="col-12 p-0 float-left">
	...
	<div class="career-form float-right w-100 px-5 py-2 bg-white col-lg-6 col-md-11 col-sm-11 col-11">
...
?>
			...
			<div id="apply-role" class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="career-role" name="career-role" disabled>
				</div>
			</div>
