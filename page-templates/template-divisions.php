...
<div class="row p-0 m-0 float-left mt-5 mb-5 divi-main">
		<div class="col-lg-3 col-md-12 divisions_main p-0 m-0 pt-5">
			<h4 class="text-white text-center mt-3 pt-3 prmy-font">DIVISIONS</h4>
			<p class="text-white pt-4 pl-5 pr-5 prmy-font divi-box">Proin congue purus at metus laoreet, vitae tempor dui pulvinar.
			Mauris eu ante facilisis, hendrerit	enim ut, ornare sem. Aenean id libero eget lectus iaculis egestas. Ut sodales tellus in odio fermentum placerat.</p>
			<p class="text-white pr-5 pl-5 pt-2 prmy-font divi-box">Suspendisse eget ultrices turpis, nec egestas est. Pellentesque at lacus in turpis maximus facilisis ut et leo. In aliquam vestibulum rhoncus Real Estate, Construction	and Entertainment.</p>
		</div>
